...
export default function Layanan() {
    ...
    <div className="w-2/4 flex flex-col gap-4">
        ...
        <LayananCard title="PELAYANAN SOSIAL" description="Penyediaan bantuan s osial bagi penduduk yang membutuhkan (misalnya, PKH, sembako, dll), Program bantuan bagi lanjut usia, difabel, atau kelompok rentan lainnya." icon="medical-icon:i-social-services"/>
